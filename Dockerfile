FROM ghcr.io/graalvm/graalvm-ce:java11-20.3.1.2 as builder

# The issue is not reproducible with this GraalVM version
...
FROM scratch
COPY --from=builder /build/target/graalvm-native-image/graal2928 /app
ENV PATH "/"
ENTRYPOINT [ "/app" ]
